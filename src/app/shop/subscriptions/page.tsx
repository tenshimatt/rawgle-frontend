    ...
    <div className="min-h-screen bg-gradient-to-br from-sea-salt via-white to-sea-salt">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center py-12 bg-white rounded-lg shadow-md max-w-2xl mx-auto">
          <RefreshCw className="h-16 w-16 text-persian-green mx-auto mb-4" />
          <h2 className="text-2xl font-bold text-charcoal mb-4">No Active Subscriptions</h2>
          <p className="text-charcoal/70 mb-6">Subscribe to get regular deliveries of raw food</p>
