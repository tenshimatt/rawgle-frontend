      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white rounded-lg p-8 shadow-md">
            ...
            <p className="text-gray-900/70 mb-6">Get guidance from experienced raw feeding enthusiasts</p>
          ...
          <div className="bg-white rounded-lg p-8 shadow-md">
            ...
            <p className="text-gray-900/70 mb-6">Share your knowledge and help newcomers succeed</p>
